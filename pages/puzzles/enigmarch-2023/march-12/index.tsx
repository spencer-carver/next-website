...
const CLUES = [
    ...
    "One of the four tallest structures in Europe, this iconic tower is often used as part of an 'establishing shot' to show where a film is taking place (17)",
        ...
        <PuzzleWrapperComponent name="enigmarch-2023:march-12">
            <Table>
                    <tbody>
                        ...
                        <tr><NonvisibleDatum /><NonvisibleDatum /><NonvisibleDatum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><Datum /><NonvisibleDatum /><NonvisibleDatum /><NonvisibleDatum /></tr>
